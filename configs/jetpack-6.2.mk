# JetPack 6.2 -> L4T R36.4.0, kernel 5.15, Ubuntu 22.04
WORKDIR        := $(CURDIR)/workspace/sdkmanager/jetpack-6.2
KERNEL_SRC     ?= $(WORKDIR)/Linux_for_Tegra/source/kernel/kernel-jammy-src
TOOLCHAIN_DIR  ?= $(WORKDIR)/toolchain
# URL exacte à relever sur la page "Jetson Linux Toolchain" NVIDIA pour R36.4.0
